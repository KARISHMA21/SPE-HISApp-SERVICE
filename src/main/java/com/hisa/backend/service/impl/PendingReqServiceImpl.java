...
@Transactional
@Service
public class PendingReqServiceImpl implements PendingReqService {
    ...
    public PendingReqServiceImpl(@Value("${cms_service.base.url}"+"/api/v1")String cmsBaseURL, RestTemplateBuilder builder){
...
//        this.restTemplate_cms=builder.build();
    ...
    public PendingRequestsResponse getPendingRequests(String eid, String did){
        ...
        cms="/his/{eid}/get-pending-requests/"+did;
...
//        List<MedicalRecordResponse> finalMeddata= new ArrayList<>();
        ...
        PendingRequests = restTemplate_cms.postForObject(cms,request_records, PendingRequestsResponse.class ,eid,did);
//        patientDemographics= restTemplate_admin.postForObject(admin,request_records, PatientDemographicsResponse.class ,pid);
        System.out.println("CMS returned pending request --> \n"+ PendingRequests.toString());
